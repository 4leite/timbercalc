Welcome to your TanStack Start static PWA.
...
The production build enables TanStack Start SPA mode and prerenders a static client shell to
`dist/client/index.html`. Cloudflare Workers Static Assets deployment is wired through:
...
After you add another route, you can use a `Link` component to navigate between routes.
...
This will create a link that will navigate to the `/contact` route.
